...
9. **🎯 다음주 추천 섹터 & ETF** - 도표 필수. 미국 추천 섹터 3-5개와 대표 ETF(티커, 이유), 국내 추천 섹터 3-5개와 대표 ETF(종목명, 이유)를 각각 도표로 정리
10. **⚖️ 자산배분 전략** - 현재 시장환경 기반 공격형/중립형/보수형 포트폴리오 자산배분 비율(주식/채권/대체자산/현금)을 도표로 제시하고, 각 유형별 핵심 전략 1-2줄 설명
11. **💡 다음주 투자 전략 제안** - 구체적 액션 아이템 3-5개
12. **📋 주간 핵심 수치 요약표** - 주요 지표를 한눈에 볼 수 있는 종합 도표
13. **🔮 주간 전망 한줄 요약** - 다음주 시장 전망을 한 문장으로 요약
